...
lib.fix (self: {
  ...
  inherit (packages) bcc-graphql hasura-cli hasura-cli-ext persistgraphql graphql-engine;
  build-version = writeText "version.json" (builtins.toJSON { inherit (bcc-graphql) rev; });
